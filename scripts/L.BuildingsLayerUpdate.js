...
function V(b,a){
  if(b.length){
    ...
    if(!moving){
      K.globalAlpha = 0.9;
      if(K.fillStyle.indexOf("125,") > -1){
        if(Math.random() > 0.5){
          K.fillStyle = texturefill2;
        }
        else{
          K.fillStyle = texturefill2b;        
        }
      }
      else if(K.fillStyle.indexOf("100,") > -1){
        if(Math.random() > 0.5){
          K.fillStyle = texturefill3;
        }
        else{
          K.fillStyle = texturefill3b;
        }
      }
      else{
        if(Math.random() > 0.5){
          K.fillStyle = texturefill;
        }
        else{
          K.fillStyle = texturefillb;        
        }
      }
      K.fill();
      K.strokeStyle = "rgba( 100, 100, 100, 0.5 )";
      //K.globalAlpha = 1;
      K.stroke();
    }
    else{
